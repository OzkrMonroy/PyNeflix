...
class SeriesItem:
    ...
    def __init__(self, root: Frame, series, row: int, col: int, delete_callback, navigation_callback) -> None:
        self._series = series
        self._row = row
        self._col = col
        self._root = root
    ...
    def __edit_series(self):
        ...
        self.controller.set_is_to_update(True, self._series)
    ...
    def __build_item(self):
        ...
        card_duration = Label(card, text=self._series.duration)
